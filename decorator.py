...
from naoimport BOT_USERNAME, dp
from nao.config import get_bool_key
from nao.modules.error import parse_update
from nao.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("nao.utils.filters." + module_name)
