...
from naoimport dp, TOKEN, bot
from nao.config import get_bool_key, get_list_key
from nao.modules import ALL_MODULES, LOADED_MODULES, MOD_HELP
...
if get_bool_key('LOAD_MODULES'):
	...
	# Load pm_menu at last
        ...
        imported_module = import_module("nao.modules." + module_name)
...
import_module('nao.modules.pm_menu')
# Import misc stuff
import_module("nao.utils.exit_gracefully")
if not get_bool_key('DEBUG_MODE'):
    import_module("nao.utils.sentry")
...
import_module("nao.utils.db_structure_migrator")
