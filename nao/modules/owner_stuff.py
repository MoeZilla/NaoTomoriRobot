...
from naoimport OWNER_ID, OPERATORS, nao_VERSION, bot, dp
from nao.decorator import REGISTRED_COMMANDS, COMMANDS_ALIASES, register
from nao.modules import LOADED_MODULES
from nao.services.mongo import db, mongodb
...
async def stats(message):
    text = f"<b>Nao {nao_VERSION} stats</b>\n"
